...
public class HLASM1Parser extends Parser {
	...
	public static final int
		EOL=1, LABEL=2, INSTRUCTION=3, MACRO=4, OPCODE=5, PARMS=6, COMMA=7, ASTER=8, 
		LBRACKET=9, RBRACKET=10, MPARM=11, EQUALS=12, NUM=13, DISPLACEMENT=14, 
		STORAGE=15, CLENGTH=16, STRING=17, DYNCLENTH=18, REGISTER=19, EQUREGISTER=20;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "EOL", "LABEL", "INSTRUCTION", "MACRO", "OPCODE", "PARMS", "COMMA", 
			"ASTER", "LBRACKET", "RBRACKET", "MPARM", "EQUALS", "NUM", "DISPLACEMENT", 
			"STORAGE", "CLENGTH", "STRING", "DYNCLENTH", "REGISTER", "EQUREGISTER"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "HLASM1Parser.g4"; }
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterProg(this);
		}
		@Override
	...
	public static class LineContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class LabelContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterLabel(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class InstructionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterInstruction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 324L) != 0)) {
				{
				{
				setState(40);
				parms();
	...
	public static class MacroContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterMacro(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class OperationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterOperation(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public final OperationContext operation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1933312L) != 0)) {
				{
				{
				setState(54);
				ooperands();
	...
	public static class ParmsContext extends ParserRuleContext {
		...
		public List<TerminalNode> COMMA() { return getTokens(HLASM1Parser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(HLASM1Parser.COMMA, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterParms(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class MoperandsContext extends ParserRuleContext {
		...
		public List<TerminalNode> EQUALS() { return getTokens(HLASM1Parser.EQUALS); }
		public TerminalNode EQUALS(int i) {
			return getToken(HLASM1Parser.EQUALS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterMoperands(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class OoperandsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterOoperands(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public static class RegisterContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HLASM1ParserListener ) ((HLASM1ParserListener)listener).enterRegister(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
	...
	public final RegisterContext register() throws RecognitionException {
		...
		try {
			...
			setState(159);
			_la = _input.LA(1);
			if ( !(_la==REGISTER || _la==EQUREGISTER) ) {
